...
/**
 * Taking the board from the discovery page.
 *
 * Named for what it does. It was PublicOpenPlayJoinController, one letter of
 * intent away from PlayerOpenPlayJoinController which puts a player in the
 * rotation, and the two were wired to forms that looked identical. A player who
 * wanted a game was told the board was open on another device.
 *
 ...
 */
class PublicOpenPlayBoardClaimController extends Controller
{

...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('tenant-subscriptions/{organization}/trial', [TenantSubscriptionController::class, 'startTrial'])->name('tenant-subscriptions.trial');
    Route::post('tenant-subscriptions/{organization}/subscribe', [TenantSubscriptionController::class, 'subscribeTenant'])->name('tenant-subscriptions.subscribe');
    ...
    Route::post('tenant-subscriptions/{organization}/invoices/{invoice}/settle', [TenantSubscriptionController::class, 'settleInvoice'])->name('tenant-subscriptions.invoices.settle');

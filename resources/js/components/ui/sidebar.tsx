...
const SidebarInset = React.forwardRef<HTMLDivElement, React.ComponentProps<'main'>>(({ className, ...props }, ref) => {
    return (
        <main
            ref={ref}
            className={cn(
                /* min-w-0: this is a flex item beside the sidebar, and its
                   default min-width:auto makes it grow to the min-content width
                   of whatever is inside — so one wide grid or table pushed the
                   whole shell sideways instead of scrolling within itself. */
